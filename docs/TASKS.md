...
| Q2 | P1 | Higher-difficulty density and spacing control | Q1 | In progress | Q2.1–Q2.4 implemented in [PR #5](https://github.com/kanze1/AUTO-OSU/pull/5), 0.3.0.dev3; [frozen evidence and local acceptance app](generation-controls.md); Q2.5 remains: automatic timing is 19/24 (below 80%) and human gameplay acceptance is pending |
| H1 | P1 | Manual and automatic highlight control | Q1, Q2 | In progress | H1.1–H1.4 prototype and four-way comparisons in [PR #5](https://github.com/kanze1/AUTO-OSU/pull/5), 0.3.0.dev3; [controls and evidence](generation-controls.md); human location labels and musicality acceptance remain; H1.5 is gated on those results |
