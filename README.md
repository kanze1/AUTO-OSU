...
已发布应用为 **0.2.0**，当前源码开发版为 **0.3.0.dev1**，节奏和坐标模型仍为 **v0**。已经能出让我自己愿意打完整首的图：节奏卡在鼓点上，跳和串都是从十几万张 ranked / approved / loved 谱面里学来的，
...
| P1 · 难度控制 | 实际星级测量、固定评估曲集、高难度密度与跨度控制 | 对比目标与实际星级，先验证 6–7★，再扩展 7–8★，同时检查局部难度峰值和手感 | 测量已接入源码版；条件校准与手感验证继续推进 |
